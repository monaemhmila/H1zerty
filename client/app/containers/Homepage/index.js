    ...
    <div className='homepage'>
      <div className='hero-section'>
        <Container className='text-center mt-2'>
          <h1 className='font-weight-bold'>Innovate Your Networking with NFC Technology</h1>
        </Container>
      </div>

      <Container className='text-center mt-2'>
        <img src='/images/qr-code.png' alt='QR Code' className='qr-code-img' />
        <p>Scan the QR code to explore our services</p>
      </Container>
      ...
      <Container className='testimonials'>
        <h2 className='text-center mb-5'>Ce que les autres disent</h2>
        <Row>
          <Col xs='12' md='4'>
